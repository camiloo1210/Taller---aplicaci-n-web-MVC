...
namespace Taller1.Controllers
{
    public class EstadiosController : Controller
    {
        ...
        public EstadiosController(TallerMVC context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstadio,Direccion,Ciudad,Cpacidad")] Estadio estadio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstadio,Direccion,Ciudad,Cpacidad")] Estadio estadio)
        {

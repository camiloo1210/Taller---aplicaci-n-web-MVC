...
namespace Taller1.Controllers
{
    ...
    {
        private readonly TallerMVC _context;

        public JugadoresController(TallerMVC context)
        {
            _context = context;
        }
        ...
        {
            var tallerMVC = _context.Jugador.Include(j => j.Equipo);
            return View(await tallerMVC.ToListAsync());
        }
        ...
        {
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "IdEquipo", "Ciudad");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdJugador,Nombre,Posicion,Edad,IdEquipo")] Jugador jugador)
        {
            ...
            ViewData["IdEquipo"] = new SelectList(_context.Equipo, "IdEquipo", "Ciudad", jugador.IdEquipo);
            return View(jugador);
        }
